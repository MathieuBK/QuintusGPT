...
with col2:
    ...
    col2.write("Bonjour, je suis QuintusGPT, votre assistant IA en cybersécurité. J'ai été entraînée sur les pages du [site de l'ANSSI](https://cyber.gouv.fr/) (Agence Nationale de la Sécurité des Systèmes d'Information). Posez-moi vos questions sur la sécurité informatique, et je ferai de mon mieux pour y répondre en vous fournissant les liens de sources pertinents pour approfondir le sujet.")
